...
CREATE TABLE `tb_blog`  (
  ...
  INDEX `idx_blog_user`(`user_id`) USING BTREE,
  INDEX `idx_blog_shop`(`shop_id`) USING BTREE,
  INDEX `idx_blog_liked`(`liked`) USING BTREE
...
CREATE TABLE `tb_blog_comments`  (
  ...
  `update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_blog_comments_blog`(`blog_id`) USING BTREE,
  INDEX `idx_blog_comments_user`(`user_id`) USING BTREE
...
CREATE TABLE `tb_follow`  (
  ...
  `create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uniq_follow_user_pair`(`user_id`, `follow_user_id`) USING BTREE,
...
CREATE TABLE `tb_voucher`  (
  ...
  `update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_voucher_shop_status`(`shop_id`, `status`) USING BTREE
